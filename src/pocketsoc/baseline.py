...
def create_baseline(data_dir: Path | None = None, profile: str = "standard") -> Path:
...
def diff_baseline(current: dict, baseline: dict, tolerance: int = 0) -> dict:
    result = {"baseline_profile": baseline.get("baseline_profile", "unknown"), "new_alerts": [], "new_checks_warning_or_critical": []}
